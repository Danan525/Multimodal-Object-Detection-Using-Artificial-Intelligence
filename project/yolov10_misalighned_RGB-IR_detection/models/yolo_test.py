...
class Model(nn.Module):
    ...
    def __init__(self, cfg='yolov10l.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/fqy/proj/paper/YOLOFusion/models/transformer/yolov10l_fusion_transformer(x3)_vedai.yaml', help='model.yaml')
