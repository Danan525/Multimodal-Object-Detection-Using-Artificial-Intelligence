...
from utils.general import coco80_to_coco91_class, check_dataset, check_file, check_img_size, init_seeds, check_requirements, \
...
def test(data,
    ...
    if not training:
        ...
        dataloader = create_dataloader_rgb_ir(val_path_rgb, val_path_ir, imgsz, batch_size, gs, opt, pad=0.5, rect=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./pre_models/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/FLIR_aligned.yaml', help='*.data path')
